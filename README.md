...
## Acknowledgements
This project was started by Sang Truong and Humberto Barreto during summer 2019 under the support of Hewlett Mellon Presidential Fund for undergraduate research at DePauw University. We thank [Frank Howland](http://persweb.wabash.edu/facstaff/howlandf/) for his help in revising an early version of this paper. We thanks Jonah Barreto for writing the JavaScript code for this website. We thank [Bu Tran](https://github.com/hieumtran) for his intial help on beautifying (color/display) the 3D barcharts in Python.
